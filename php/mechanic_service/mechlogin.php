...
<div class="container">
    ...
    <div class="wrapper">
        <h2 class="text-center">Mobile Workshop Technician</h2>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="signup" role="tabpanel">
                <form action="mechlogin.php" method="POST">
                    <div class="form-group">
 ...
 if(isset($_POST['Signup']))
{
 ...
 if($con){
 $q="select email from mechanic_reg_request where email='$email'";
 $result=$con->query($q);
 ...
 $q="insert into mechanic_reg_request values($license,'$name','$email','$pass','$lat','$lon','$type','$place')";
 if($con->query($q)){
 echo "<script>
...
if(isset($_POST['login'])){
 ...
 $db="rrh";
  ...
  $q1="SELECT * FROM mechanic_reg WHERE email='$email' AND password='$password'";
  $r=$con->query($q1);
  if($r->num_rows > 0)
  {
    session_unset();
    ...
    echo "<script>window.location.href = 'mechanic-index.php';</script>";
    exit();
  }
