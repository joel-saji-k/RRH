...
if (isset($_POST['savechange'])){
    ...
    if (!$con) {
        ...
        $q = "UPDATE mechanic_reg SET name='$Name',email='$Email',place='$Place',status='$Status' WHERE email='$email' AND password='$password'";
        $result = $con->query($q);
        if ($result) {
  ...
  if (isset($_POST['changepass'])){
    ...
    if (!$con) {
        ...
        $q = "SELECT password FROM mechanic_reg WHERE email='$email' AND password='$password'";
         $result = $con->query($q);
        $row = $result->fetch_assoc();
        $pascheck = $row['password'];
       
        if($pascheck==$Pass){
        $q = "UPDATE mechanic_reg SET password='$newPass' WHERE email='$email' AND password='$password'";
...
if (isset($_SESSION['email']) && isset($_SESSION['password'])) {
    ...
    if (!$con) {
        ...
        $q = "SELECT * FROM mechanic_reg WHERE email='$email' AND password='$password'";
        $result = $con->query($q);
...
?>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="mechanic-profile.php">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="mechanic-amount.php">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo htmlspecialchars($license); ?></div>
                  </div>
                    <div class="row">
                    <div class="col-lg-3 col-md-4 label">Place</div>
                    <div class="col-lg-9 col-md-8"><?php echo htmlspecialchars($place); ?></div>
                  </div>
